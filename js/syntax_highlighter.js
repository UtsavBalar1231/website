...
export function highlight_code(code, language) {
    ...
    try {
        ...
        const ret = wasm.highlight_code(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
 ...
 * @param {string | null} [language]
 */
export function highlight_element(element_id, language) {
    const ptr0 = passStringToWasm0(element_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(language) ? 0 : passStringToWasm0(language, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    const ret = wasm.highlight_element(ptr0, len0, ptr1, len1);
    if (ret[1]) {
 ...
 */
export function highlight_all_code_blocks() {
    const ret = wasm.highlight_all_code_blocks();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_97c9743d4e6e289e = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('syntax_highlighter_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
